...
public class HttpCode {
    ...
    static {
        ...
        memoMap.put(300, "（多种选择） 针对请求，服务器可执行多种操作。服务器可根据请求者 (EbizUser agent) 选择一项操作，或提供操作列表供请求者选择。");
    ...
    public void setCode(int code) {
        this.code = code;
        setBrief(briefMap.getOrDefault(code / 100, "未知"));
        setMemo(memoMap.getOrDefault(code, "未知"));
    }
